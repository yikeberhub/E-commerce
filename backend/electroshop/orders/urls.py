...
from .views import OrderListView,UserOrderStatusListView, UserSalesChartView,OrderDetailView,OrderUpdateView,OrderStatusUpdateView,OrderCancelView,CheckoutView
urlpatterns = [
